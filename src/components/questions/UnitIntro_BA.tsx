...
const SCENES: Scene[] = [
  ...
  // Two-forms announcement comes RIGHT after introducing the letter
  {
    id: 2,
    bg: '#F5F0FF',
    accent: '#7C3AED',
  ...
  // Then words showing بـ (connected, beginning)
  {
    id: 3,
    bg: '#ECFDF5',
    accent: '#059669',
    ...
    title: 'بـ — اول کلمه',
    subtitle: 'بز با بـ شروع میشه',
    speak: 'بز. بـ اول کلمه‌ست',
    mascotExpression: 'happy',
  },
  {
    id: 4,
    ...
    highlightColor: '#7C3AED',
    title: 'بـ — اول کلمه',
    subtitle: 'بادکنک هم با بـ شروع میشه',
    speak: 'بادکنک. بادکنک هم با بـ شروع میشه',
    mascotExpression: 'excited',
  },
  {
    id: 5,
  ...
  // Then words showing ب (standalone, end)
  {
    id: 6,
    bg: '#ECFDF5',
    accent: '#059669',
