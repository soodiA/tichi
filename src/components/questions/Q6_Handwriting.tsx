...
const STROKE_PATHS: Record<string, [number, number][][]> = {
  ...
  'بـ': [
    [[232, 136], [232, 200], [67, 200], [66, 137]],    // same U-shape as final ب
    [[147, 249], [162, 258]],
  ],
  'پ': [
  ...
  'پـ': [
    [[232, 136], [232, 200], [67, 200], [66, 137]],    // same U-shape as final پ
    [[107, 247], [118, 258]], [[147, 249], [162, 258]], [[181, 247], [192, 258]],
  ],
  'ت': [
    [[232, 136], [232, 200], [67, 200], [66, 137]],
  ...
  'تـ': [
    [[232, 136], [232, 200], [67, 200], [66, 137]],    // same U-shape as final ت
    [[126, 114], [136, 126]], [[166, 116], [177, 128]],
  ],
  'ث': [
    [[232, 136], [232, 200], [67, 200], [66, 137]],
  ...
  'ثـ': [
    [[232, 136], [232, 200], [67, 200], [66, 137]],    // same U-shape as final ث
    [[166, 116], [177, 128]],
    [[126, 114], [136, 126]],
    [[145, 89], [156, 98]],
  ],
  ...
  // ── او (combined alef+vav — و sits further left and ا further right
  // than their standalone positions once shaped together; measured via
  // rendered glyph bounding boxes, not just reused from 'ا'/'و' above) ──
  'او': [
    [[204, 61], [204, 221]],
    [[126, 211], [90, 201], [78, 163], [99, 134], [126, 131], [150, 149], [158, 178], [158, 217], [143, 248], [124, 264], [84, 285]],
  ],
