...
const STROKE_PATHS: Record<string, [number, number][][]> = {
  ...
  // ── ج family ─────────────────────────────────────────────────
  'ج': [
    [[162, 148], [148, 168], [138, 198], [142, 232], [162, 240], [188, 222]],
    [[148, 258]],
  ],
  'چ': [
    [[162, 148], [148, 168], [138, 198], [142, 232], [162, 240], [188, 222]],
    [[132, 258]], [[148, 265]], [[165, 258]],
  ],
  'ح': [
    [[162, 148], [148, 168], [138, 198], [142, 232], [162, 240], [188, 222]],
  ],
  ...
  // ── س ────────────────────────────────────────────────────────
  'س': [
    [[185, 180], [170, 202], [155, 182], [140, 202], [122, 182], [108, 205], [95, 188]],
  ],
  'ش': [
    [[185, 180], [170, 202], [155, 182], [140, 202], [122, 182], [108, 205], [95, 188]],
    [[120, 148]], [[138, 138]], [[155, 148]],
  ],

  // ── ف ────────────────────────────────────────────────────────
  'ف': [
    [[162, 162], [140, 145], [115, 158], [112, 180], [138, 195], [165, 188], [178, 170], [162, 148]],
    [[142, 125]],
  ],
  ...
  // ── ل ────────────────────────────────────────────────────────
  'ل': [
    [[150, 82], [144, 158], [138, 218], [145, 245], [165, 250]],
  ],
  ...
  // ── و ────────────────────────────────────────────────────────
  'و': [
    [[162, 148], [175, 168], [172, 200], [152, 218], [128, 208]],
  ],
  ...
  // ── ط ────────────────────────────────────────────────────────
  'ط': [
    [[155, 88], [153, 165], [150, 240]],    // vertical stem
    [[168, 165], [148, 152], [125, 162], [118, 185], [165, 185]], // bowl around
  ],
